...
public class Acessa_Papelaria {
	public static void main(String [] args) {
		...
		System.out.println("lápis tipo: " + b.get_lápis() + "\n");
		...
		System.out.println("quantidade de caixas de lápis de cor: " + d.get_quantidade_caixas_lápis());
		
		Caderno e = new Caderno();
		
		e.set_cor("azul");
		e.set_capa("capa dura");
		e.set_qtd_páginas(100);
		System.out.println("\nCaderno \n");
		System.out.println("cor do caderno: \t"+ e.get_cor() );
		System.out.println("tipo de capa: \t"+ e.get_capa() );
		System.out.println("quantidade de folhas: \t"+ e.get_qtd_páginas() );
	}
