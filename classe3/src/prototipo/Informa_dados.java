...
public static void main (String [] args) {
	...
	janela.show(); //método descontinuado, obsoleto
	WindowListener x = new WindowAdapter()
		{ public void windowClosing (WindowEvent fecha) //método oculto
			{System.exit(0);}
		};
...
Informa_dados(){
	...
	System.out.println("CARTÃO DO CONTRIBUINTE\t" + receita.getCartao());
	if (j1 == true)
